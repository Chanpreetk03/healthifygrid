		...
		<div className='container mx-auto px-4 sm:px-6 lg:px-8 py-12'>
			...
			<div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
				<Card>
					...
					<CardContent>
						<Image src={harmonics} alt='Harmonics Waveform' width={400} height={200} className='rounded-md mb-4' />
					...
					<CardFooter>
						<Button variant='outline' className='w-full' asChild>
							<Link
								target='_blank'
								href='https://web.ecs.baylor.edu/faculty/grady/understanding_power_system_harmonics_grady_april_2012.pdf'>
								Read More
							</Link>
						</Button>
					</CardFooter>
				...
				<Card>
					...
					<CardContent>
						<Image src={casestudy} alt='Steel Plant' width={400} height={200} className='rounded-md mb-4' />
						<p className='text-muted-foreground'>
					...
					<CardFooter>
						<Button variant='outline' className='w-full' asChild>
							<Link target='_blank' href='https://www.mdpi.com/1996-1073/14/8/2278'>
								Read More
							</Link>
						</Button>
					</CardFooter>
				...
				<Card>
					...
					<CardContent>
						<Image src={regulation} alt='Regulations Document' width={400} height={200} className='rounded-md mb-4' />
						<p className='text-muted-foreground'>
					...
					<CardFooter>
						<Button variant='outline' className='w-full' asChild>
							<Link
								target='_blank'
								href='https://www.teamleaseregtech.com/updates/article/22538/punjab-state-electricity-regulatory-commission-power-quality-regulatio/'>
								Read More
							</Link>
						</Button>
					</CardFooter>
					...
					<Card key={item}>
						...
						<CardFooter>
							<Button variant='ghost' size='sm' className='w-full' asChild>
								<Link href='/knowledgehub/regulations'>View</Link>
							</Button>
						</CardFooter>
					</Card>
				))}
